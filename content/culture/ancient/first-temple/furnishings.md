+++
title = "The Furnishings"
linkTitle = "Furnishings"
description = "An interactive walk-through of Solomon's Temple — the court, the sanctuary, and the oracle. Tap each furnishing in order to open what the text says, what the reconstruction infers, what it meant, and how Latter-day Saints read it."
image = "/images/culture/first-temple/exterior.jpg"
weight = 5
...
{{< temple-scene scene="holy-of-holies" >}}
...
<div class="ft-video" style="max-width:760px;margin:1.7rem auto 0;">
  <iframe style="display:block;width:100%;aspect-ratio:16/9;border:0;border-radius:12px;box-shadow:0 8px 26px rgba(56,55,49,.14);" src="https://www.youtube-nocookie.com/embed/3a9g8Q7_Wpk" title="Finding Christ in the Ark of the Covenant — Messages of Christ" loading="lazy" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
  <p style="text-align:center;font-size:0.82rem;line-height:1.5;color:#718096;margin:0.6rem 0 0;font-family:system-ui,-apple-system,sans-serif;">▶ <strong>Finding Christ in the Ark of the Covenant</strong> — video by <a href="https://www.youtube.com/watch?v=3a9g8Q7_Wpk" target="_blank" rel="noopener" style="color:#4a6b52;">Messages of Christ (Daniel Smith)</a>, used with permission.</p>
</div>

---

Each object, then, was a word in a single sentence the architecture spoke from the gates inward: *enter* (the bronze court gates), *atone* (the altar), *wash* (the sea and lavers), *establish and strengthen* (the pillars and the gold doors), *be lit and fed and heard* (the Holy Place), *and so come near* (the oracle). Walk the plan itself on the [interactive floor plan →](/culture/ancient/first-temple/explore-the-floor-plan/), or read how the whole house was given to God at the [Dedication →](/culture/ancient/first-temple/dedication/).
