...
<p>The Persians and their close kin the <strong>Medes</strong> were <em>Iranian</em> peoples &mdash; speakers of an Indo-European language distantly related to Sanskrit, Greek, and Latin, and quite unrelated to the Semitic languages (Akkadian, Aramaic, Hebrew) of Mesopotamia and Canaan. Their ancestors had migrated down onto the Iranian plateau from the Eurasian steppe in the second millennium BC, herders and horsemen settling among older peoples. By the time they enter history, the Medes had built a kingdom centered on <strong>Ecbatana</strong> (modern Hamadan) and had helped Babylon destroy Assyria in 612 BC (see the <a href="/culture/ancient/babylon/02-timeline-and-empires/">Babylon timeline</a>); the Persians held the southern region of <strong>Persis</strong> (modern Fars, around Shiraz) as Median vassals.</p>

<p>The Bible files them together from the start &mdash; &ldquo;the law of the Medes and Persians&rdquo; (<a href="https://www.blueletterbible.org/kjv/dan/6/8/" target="_blank" data-ref="Daniel 6:8">Daniel 6:8</a>), &ldquo;the Persians and the Medes&rdquo; (<a href="https://www.blueletterbible.org/kjv/est/1/19/" target="_blank" data-ref="Esther 1:19">Esther 1:19</a>) &mdash; and Daniel&rsquo;s vision of the two-horned ram makes the relationship exact: &ldquo;The ram which thou sawest having two horns are the kings of Media and Persia&rdquo; (<a href="https://www.blueletterbible.org/kjv/dan/8/20/" target="_blank" data-ref="Daniel 8:20">Daniel 8:20</a>), one horn higher than the other and coming up last &mdash; Persia, the junior partner, rising to dominate the senior.</p>

<div style="background: linear-gradient(135deg, #f5f3f0 0%, #ebe7e1 100%); padding: 20px 24px; border-radius: 8px; margin: 24px 0;">
<p style="margin: 0;"><strong>A different kind of empire:</strong> Assyria and Babylon had ruled by terror and deportation &mdash; smashing rebellious peoples, uprooting whole populations (Judah among them), and planting them far from home. Persia, by deliberate policy, did the opposite: it let subject peoples keep their gods, their customs, their local leaders, and &mdash; famously &mdash; sent the deported home to rebuild their own temples. This was not sentimentality; it was a shrewd governing philosophy that bought loyalty cheaply across an impossibly diverse empire (see <a href="/culture/ancient/achaemenid/03-how-the-empire-worked/">Section 03</a>). But for one small people, that policy was salvation, and their scriptures never forgot it.</p>
</div>
...
<ul>
<li><strong>Lydia (c. 547 BC)</strong> &mdash; the fabulously wealthy kingdom of King Croesus in western Anatolia, giving Persia the Greek cities of the Aegean coast and setting up the later Greco-Persian wars.</li>
