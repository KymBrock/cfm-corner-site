---
title: "Pre-Holy Week — Bethany"
description: "Jesus arrives in Bethany where Lazarus lives — the man He raised from the dead weeks earlier. Mary of Bethany anoints Jesus with precious ointment, setting the stage for Holy Week."
weight: 0
image: /images/culture/holy-week/00-pre-week.png
hide_nav: true
---

<div style="text-align: center; margin: 0 auto 24px;">
<img src="/images/culture/holy-week/00-pre-week.png" alt="Pre-Holy Week — Bethany Anointing" style="width: 150px; height: 150px; border-radius: 50%;">
</div>
...
<!-- Header Row -->
<div style="display: grid; grid-template-columns: 2fr repeat(5, 1fr); background: #be8b55; color: white; font-weight: bold; text-align: center; border-radius: 8px 8px 0 0;">
...
<div style="padding: 12px; display: flex; align-items: center; gap: 8px;"><span style="color: #be8b55; font-size: 0.8em;">▶</span> Arrival in Bethany</div>
...
<!-- Row 2: Raising of Lazarus (Background) -->
<details style="border-bottom: 1px solid #ddd;">
...
<div style="padding: 12px; display: flex; align-items: center; gap: 8px;"><span style="color: #be8b55; font-size: 0.8em;">▶</span> <em>Background:</em> Raising of Lazarus</div>
<div style="padding: 12px; text-align: center;">—</div>
<div style="padding: 12px; text-align: center;">—</div>
<div style="padding: 12px; text-align: center;">—</div>
...
<!-- Row 3: Mary of Bethany anoints Jesus' feet -->
<details style="border-bottom: 1px solid #ddd;">
<summary style="display: grid; grid-template-columns: 2fr repeat(5, 1fr); padding: 0; cursor: pointer; background: #f0ebe5; list-style: none;">
<div style="padding: 12px; display: flex; align-items: center; gap: 8px;"><span style="color: #be8b55; font-size: 0.8em;">▶</span> Mary of Bethany anoints Jesus' feet</div>
<div style="padding: 12px; text-align: center;">—</div>
<div style="padding: 12px; text-align: center;">—</div>
<div style="padding: 12px; text-align: center;">—</div>
...
<!-- Row 4: Judas criticizes Mary -->
<details style="border-bottom: 1px solid #ddd;">
<summary style="display: grid; grid-template-columns: 2fr repeat(5, 1fr); padding: 0; cursor: pointer; background: white; list-style: none;">
<div style="padding: 12px; display: flex; align-items: center; gap: 8px;"><span style="color: #be8b55; font-size: 0.8em;">▶</span> Judas criticizes the anointing</div>
<div style="padding: 12px; text-align: center;">—</div>
<div style="padding: 12px; text-align: center;">—</div>
<div style="padding: 12px; text-align: center;">—</div>
...
<!-- Row 5: Priests plot against Jesus & Lazarus -->
<details style="border-bottom: 1px solid #ddd; border-radius: 0 0 8px 8px;">
<summary style="display: grid; grid-template-columns: 2fr repeat(5, 1fr); padding: 0; cursor: pointer; background: #f0ebe5; list-style: none; border-radius: 0 0 8px 8px;">
<div style="padding: 12px; display: flex; align-items: center; gap: 8px;"><span style="color: #be8b55; font-size: 0.8em;">▶</span> Priests plot against Jesus & Lazarus</div>
<div style="padding: 12px; text-align: center;">—</div>
<div style="padding: 12px; text-align: center;">—</div>
<div style="padding: 12px; text-align: center;">—</div>
...
<span style="color: #be8b55;">▶</span> Word Studies: Spikenard & Anointing
</summary>
<div style="padding: 20px 24px; background: white;">

### Spikenard — נֵרְדְּ / νάρδος

<a href="https://www.blueletterbible.org/lexicon/g3487/kjv/tr/0-1/" target="_blank" data-lexicon="spikenard, nard" data-strongs="G3487" data-translit="nardos" data-original="νάρδος" data-lang="greek">νάρδος</a> (*nardos*) — from Hebrew <a href="https://www.blueletterbible.org/lexicon/h5373/kjv/wlc/0-1/" target="_blank" data-lexicon="spikenard" data-strongs="H5373" data-translit="nerd" data-original="נֵרְדְּ" data-lang="hebrew">נֵרְדְּ</a> (*nerd*)
...
<a href="https://www.blueletterbible.org/lexicon/g5548/kjv/tr/0-1/" target="_blank" data-lexicon="to anoint" data-strongs="G5548" data-translit="chriō" data-original="χρίω" data-lang="greek">χρίω</a> (*chriō*) — to anoint, to consecrate

This is the root of <a href="https://www.blueletterbible.org/lexicon/g5547/kjv/tr/0-1/" target="_blank" data-lexicon="anointed, Messiah" data-strongs="G5547" data-translit="Christos" data-original="Χριστός" data-lang="greek">Χριστός</a> (*Christos*, "Christ") — "the Anointed One." The Hebrew equivalent is <a href="https://www.blueletterbible.org/lexicon/h4899/kjv/wlc/0-1/" target="_blank" data-lexicon="anointed, Messiah" data-strongs="H4899" data-translit="mashiach" data-original="מָשִׁיחַ" data-lang="hebrew">מָשִׁיחַ</a> (*mashiach*, "Messiah").
...
<div style="margin: 32px 0; padding: 24px 28px; background: linear-gradient(135deg, #faf8f5 0%, #f5f0e8 100%); border-left: 5px solid #be8b55; border-radius: 0 12px 12px 0; box-shadow: 0 2px 8px rgba(190,139,85,0.1);">

<h3 style="margin-top: 0; color: #8b6914; display: flex; align-items: center; gap: 10px;">
<span style="font-size: 1.2em;">📜</span> Scholar's Note: Temple Imagery in John 11–12
</h3>
...
<!-- Prophet Card -->
<div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 12px rgba(0,0,0,0.08); border-top: 4px solid #be8b55;">
...
<!-- Saturday Anointing -->
<div style="background: linear-gradient(to bottom, #faf8f5, white); border-radius: 12px; padding: 24px; border: 1px solid #e8e0d5; position: relative;">
...
<!-- Wednesday Anointing -->
<div style="background: linear-gradient(to bottom, #faf8f5, white); border-radius: 12px; padding: 24px; border: 1px solid #e8e0d5; position: relative;">
<div style="position: absolute; top: -12px; left: 20px; background: #8b6914; color: white; padding: 4px 16px; border-radius: 20px; font-size: 0.85em; font-weight: bold;">WEDNESDAY</div>
<h3 style="margin: 12px 0 16px; color: #8b6914;">Unnamed Woman Anoints His Head</h3>
<p style="margin: 0 0 12px;">Matthew and Mark place this anointing at Simon the Leper's house. By anointing Jesus' <strong>head</strong>, she symbolically anointed Him as the <strong>great High Priest</strong>.</p>
<p style="margin: 0; font-size: 0.95em; color: #666;">He would soon enter God's presence — not with the blood of bulls and goats, but with His own blood.</p>
<div style="margin-top: 16px; padding-top: 12px; border-top: 1px dashed #8b6914; text-align: center;">
<span style="background: #f0ebe5; padding: 6px 14px; border-radius: 20px; font-size: 0.9em; color: #8b6914;">⛪ Priest</span>
</div>
</div>

</div>

<div style="text-align: center; margin: 16px 0; padding: 16px; background: #f0ebe5; border-radius: 8px;">
Together, these women unknowingly testified that Jesus was both <strong>King and Priest</strong> — and through His teachings, also <strong>Prophet</strong>. Jesus is the only one who fulfills all three anointed offices.
</div>
...
<h3 style="margin: 0 0 16px; color: #8b6914;">Mary's Prophetic Act</h3>
...
<div style="background: white; border-radius: 12px; padding: 24px; box-shadow: 0 2px 8px rgba(0,0,0,0.06);">
<h3 style="margin: 0 0 16px; color: #8b6914;">Women as Witnesses</h3>
<p>The anointing events highlight the role of women as powerful witnesses of Christ's divinity. In a patriarchal society, Jesus elevated and honored Mary's devotion, rebuking those who criticized her.</p>
<h3 style="margin: 24px 0 16px; color: #8b6914;">Temple Connections</h3>
<p style="margin: 0;">The anointing with oil connects to Latter-day Saint temple ordinances where members are anointed as part of sacred covenants. Just as Mary anointed Christ's body, temple participants are symbolically prepared for sacred purposes.</p>
</div>
...
<div style="margin: 32px 0; padding: 28px; background: linear-gradient(135deg, #be8b55 0%, #8b6914 100%); border-radius: 12px; color: white;">

<h2 style="margin: 0 0 20px; color: white; border-bottom: 1px solid rgba(255,255,255,0.3); padding-bottom: 12px;">Reflection Questions</h2>

<div style="display: grid; gap: 16px;">

<div style="display: flex; gap: 16px; align-items: flex-start;">
<span style="background: rgba(255,255,255,0.2); color: white; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-weight: bold;">1</span>
<p style="margin: 0;">Mary's gift cost a year's wages. What moved her to give so extravagantly — and what does Jesus' response reveal about how He receives our offerings?</p>
</div>

<div style="display: flex; gap: 16px; align-items: flex-start;">
<span style="background: rgba(255,255,255,0.2); color: white; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-weight: bold;">2</span>
<p style="margin: 0;">Judas saw "waste" where Jesus saw worship. What might this contrast teach us about how God values things differently than the world does?</p>
</div>

<div style="display: flex; gap: 16px; align-items: flex-start;">
<span style="background: rgba(255,255,255,0.2); color: white; width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-weight: bold;">3</span>
<p style="margin: 0;">Jesus said Mary's act would be remembered "wherever the gospel is preached." What does this tell us about how He honors sincere devotion?</p>
</div>
...
<a href="https://www.youtube.com/watch?v=GDZAF6hrDt8" target="_blank" style="text-decoration: none; color: inherit;">
<div style="border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
<img src="https://img.youtube.com/vi/GDZAF6hrDt8/hqdefault.jpg" alt="The Raising of Lazarus" style="width: 100%; display: block;">
<div style="padding: 12px; background: #f0ebe5;">
<strong>The Raising of Lazarus</strong><br>
<span style="font-size: 0.9em; color: #666;">"I am the resurrection, and the life"</span>
</div>
</div>
</a>

<a href="https://www.youtube.com/watch?v=nhNZ_lVxJ2Q" target="_blank" style="text-decoration: none; color: inherit;">
<div style="border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
<img src="https://img.youtube.com/vi/nhNZ_lVxJ2Q/hqdefault.jpg" alt="The Anointing of Jesus by Women" style="width: 100%; display: block;">
<div style="padding: 12px; background: #f0ebe5;">
<strong>The Anointing of Jesus by Women</strong><br>
<span style="font-size: 0.9em; color: #666;">Prophet, Priest, and King — the three anointed offices</span>
</div>
</div>
</a>
...
- <a href="https://www.youtube.com/watch?v=sfvzTm1mOCQ" target="_blank">Raising of Lazarus</a>
- <a href="https://www.youtube.com/watch?v=cefttBItKic" target="_blank">Jesus Anointed at Bethany</a>
...
- <a href="https://www.holylandsite.com/bethany" target="_blank">Holy Land Site: Bethany</a>
