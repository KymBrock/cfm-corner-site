...
description: "The glorious morning of Christ's resurrection — death is conquered, the tomb is empty, and hope dawns eternal."
weight: 8
image: /images/culture/holy-week/08-resurrection.png
hide_nav: true
---

<div style="text-align: center; margin: 0 auto 24px;">
<img src="/images/culture/holy-week/08-resurrection.png" alt="Easter Sunday — He Is Risen" style="width: 150px; height: 150px; border-radius: 50%;">
</div>
...
<!-- Header Row -->
<div style="display: grid; grid-template-columns: 2fr repeat(5, 1fr); background: #c9a227; color: white; font-weight: bold; text-align: center; border-radius: 8px 8px 0 0;">
...
<!-- Row 1: Earthquake, angels open tomb -->
...
<!-- Row 4: Peter and John run to tomb -->
<details style="border-bottom: 1px solid #ddd;">
<summary style="display: grid; grid-template-columns: 2fr repeat(5, 1fr); padding: 0; cursor: pointer; background: white; list-style: none;">
...
<!-- Row 5: Mary Magdalene sees the Lord -->
<details style="border-bottom: 1px solid #ddd;">
<summary style="display: grid; grid-template-columns: 2fr repeat(5, 1fr); padding: 0; cursor: pointer; background: #f0ebe5; list-style: none;">
...
<!-- Row 6: Officials bribe soldiers -->
<details style="border-bottom: 1px solid #ddd;">
<summary style="display: grid; grid-template-columns: 2fr repeat(5, 1fr); padding: 0; cursor: pointer; background: white; list-style: none;">
...
<!-- Row 8: Jesus appears to disciples -->
<details style="border-bottom: 1px solid #ddd;">
<summary style="display: grid; grid-template-columns: 2fr repeat(5, 1fr); padding: 0; cursor: pointer; background: white; list-style: none;">
...
<div style="padding: 12px; display: flex; align-items: center; gap: 8px;"><span style="color: #c9a227; font-size: 0.8em;">▶</span> Thomas believes (8 days later)</div>
<div style="padding: 12px; text-align: center;">—</div>
<div style="padding: 12px; text-align: center;">—</div>
<div style="padding: 12px; text-align: center;">—</div>
...
<div style="margin-top: 24px; padding: 20px; background: linear-gradient(135deg, #f0ebe5 0%, #faf8f5 100%); border-radius: 8px; border-left: 4px solid #c9a227;">
...
<h4 style="color: #c9a227; margin-bottom: 8px;">Risen — ἐγείρω</h4>
...
<div style="margin-bottom: 24px;">
<h4 style="color: #c9a227; margin-bottom: 8px;">Touch Me Not — μή μου ἅπτου</h4>
...
<div>
<h4 style="color: #c9a227; margin-bottom: 8px;">Resurrection — ἀνάστασις</h4>

<a href="https://www.blueletterbible.org/lexicon/g386/kjv/tr/0-1/" target="_blank" data-lexicon="a rising up, resurrection" data-strongs="G386" data-translit="anastasis" data-original="ἀνάστασις" data-lang="greek">ἀνάστασις</a> (*anastasis*) — from *ana* (up) + *histēmi* (to stand)
...
<div style="margin: 32px 0; padding: 24px 28px; background: linear-gradient(135deg, #faf8f5 0%, #f5f0e8 100%); border-left: 5px solid #c9a227; border-radius: 0 12px 12px 0; box-shadow: 0 2px 8px rgba(201,162,39,0.15);">
<h3 style="margin-top: 0; color: #a68520; display: flex; align-items: center; gap: 10px;">
...
<h4 style="margin-bottom: 8px; color: #1e4a6c;">Book of Mormon Witness</h4>
<p style="margin-bottom: 0;">The Book of Mormon provides additional testimony: <em>"The spirit and the body shall be reunited again in its perfect form; both limb and joint shall be restored to its proper frame"</em> (<a href="https://www.churchofjesuschrist.org/study/scriptures/bofm/alma/11?lang=eng&id=43" target="_blank" data-ref="Alma 11:43">Alma 11:43</a>). Christ later appeared to the Nephites as a resurrected being, inviting them to feel the wounds in His hands and feet (<a href="https://www.churchofjesuschrist.org/study/scriptures/bofm/3-ne/11?lang=eng&id=14-15" target="_blank" data-ref="3 Nephi 11:14-15">3 Nephi 11:14–15</a>).</p>
</div>

<div>
<h4 style="margin-bottom: 8px; color: #1e4a6c;">Modern Revelation</h4>
<p style="margin-bottom: 0;">Joseph Smith testified of seeing the resurrected Christ: <em>"We beheld the glory of the Son, on the right hand of the Father"</em> (<a href="https://www.churchofjesuschrist.org/study/scriptures/dc-testament/dc/76?lang=eng&id=20" target="_blank" data-ref="D&C 76:20">D&C 76:20</a>). The Restoration began with a resurrected Christ appearing to a young prophet — extending the witness of the empty tomb into the modern age.</p>
</div>
</div>
...
2. The Emmaus disciples walked with Jesus for hours without recognizing Him, yet knew Him instantly "in the breaking of bread." What might this teach about how Christ reveals Himself?

3. Thomas doubted, yet Jesus met him where he was. What does this interaction reveal about how Christ responds to honest questions?
...
<a href="https://www.youtube.com/watch?v=KUCVL3xt9XA" target="_blank" style="text-decoration: none; color: inherit;">
<div style="border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
<img src="https://img.youtube.com/vi/KUCVL3xt9XA/hqdefault.jpg" alt="Mary Magdalene" style="width: 100%; display: block;">
<div style="padding: 12px; background: #f0ebe5;">
<strong>Mary Magdalene, the First Witness</strong><br>
<span style="font-size: 0.9em; color: #666;">The first to see the risen Lord</span>
</div>
</div>
</a>

<a href="https://www.youtube.com/watch?v=9bBDlqbxU4U" target="_blank" style="text-decoration: none; color: inherit;">
<div style="border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
<img src="https://img.youtube.com/vi/9bBDlqbxU4U/hqdefault.jpg" alt="Doubting Thomas" style="width: 100%; display: block;">
<div style="padding: 12px; background: #f0ebe5;">
<strong>Doubting Thomas or Witness?</strong><br>
<span style="font-size: 0.9em; color: #666;">"My Lord and my God"</span>
</div>
</div>
</a>
...
- <a href="https://www.youtube.com/watch?v=MlKetn7ZiNU" target="_blank">Jesus Is Resurrected</a>
- <a href="https://www.youtube.com/watch?v=bAuaSpJ7zGs" target="_blank">He Is Risen</a>
- <a href="https://www.youtube.com/watch?v=kP3753Pc8-w" target="_blank">The Risen Lord Appears to the Apostles</a>
- <a href="https://www.youtube.com/watch?v=F8o4TrIA76U" target="_blank">Thomas: Blessed Are They That Believe</a>
- <a href="https://www.youtube.com/watch?v=8YlzWPPiH4A" target="_blank">Road to Emmaus</a>
