---
title: "Digital Tools"
description: "Interlinear bibles, concordances, lexicons, and study software for scripture research"
---
...
- **[Blue Letter Bible](https://www.blueletterbible.org/)** — Excellent free online interlinear bible, dictionary, lexicon, and concordance. Very reliable. The interlinear bible parses individual words, helping readers understand how translators have interpreted the grammar. Lists every time a word is used in the Biblical record.

- **[Bible Hub](https://biblehub.com/)** — User-friendly interlinear bible, more intuitive for beginners. Has alphabetical Hebrew and Greek concordance making it easy to find words with Strong's numbers. Also includes timelines and commentaries. *(Note: cross-reference recommended as occasional mistakes exist.)*

- **[Webster's 1828 Dictionary](https://webstersdictionary1828.com/)** — Online edition of Webster's monumental work, based extensively on the KJV. Useful for understanding words in context of the early nineteenth century, relevant to both KJV and Book of Mormon.

- **[Sefaria](https://www.sefaria.org/)** — Free online database with over 3,000 years of Jewish texts. Multiple dictionaries, translations, and commentaries. Does not use Strong's numbers — requires looking up words by their roots.

- **[STEP Bible (Tyndale House)](https://www.stepbible.org/)** — Free, academically rigorous interlinear bible with excellent morphological parsing, built by Cambridge scholars. Superior to Bible Hub for detailed Hebrew word analysis.
...
- **[LOGOS](https://www.logos.com/)** — Biblical software used by serious academics. Huge collections and libraries, can be expensive. Well-respected in academic circles.

- **[Accordance](https://www.accordancebible.com/)** — Biblical software for advanced scholarship. Smaller collection than LOGOS but more intuitive. Includes lexicons, concordances, dictionaries, commentaries, and various biblical codices in original languages (Dead Sea Scrolls, Septuagint, Vulgate, Tanakh, Nag Hammadi texts, etc.).
...
- **[Scripture Central CFM Guide](https://scripturecentral.org/come-follow-me)** — Multiple resources and insights for each week's curriculum.

- **[John Hilton III's CFM Resources](https://johnhiltoniii.com/)** — Excellent insights and materials.

- **[BYU RSC CFM Collection](https://rsc.byu.edu/come-follow-me)** — Articles from BYU's Religious Studies Center corresponding to the CFM curriculum.
...
- **[BYU Religious Studies Center](https://rsc.byu.edu/)** — Founded in 1975 under Dean Jeffrey R. Holland. Sponsors and publishes gospel-related academic materials.
...
- **[Biblical Archaeology Society](https://www.biblicalarchaeology.org/)** — Publisher of *Biblical Archaeology Review*. Articles on archaeological discoveries, ancient cultures, and biblical context. Some free, some paywalled — the free content alone is excellent.

- **[Dead Sea Scrolls Digital Library (Israel Museum)](https://www.deadseascrolls.org.il/)** — High-resolution images of actual Dead Sea Scroll manuscripts. Fascinating companion to Old Testament text study.

- **[Chabad.org — Torah with Rashi](https://www.chabad.org/library/bible_cdo/aid/63255/jewish/The-Bible-with-Rashi.htm)** — Rashi's classic Torah commentary alongside the Hebrew text. The foundational Jewish commentary on the Old Testament — provides invaluable perspective alongside LDS study.
